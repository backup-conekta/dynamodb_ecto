defmodule Dynamo.Ecto.ChangeMap do
  @moduledoc """
  An Ecto type to represent a partial update of a nested document

  ## Using in queries

      change = Dynamo.Ecto.Helpers.change_map("name", "name")
...
defmodule Dynamo.Ecto.ChangeArray do
  @moduledoc """
  An Ecto type to represent a partial update of a nested document

  ## Using in queries

      change = Dynamo.Ecto.Helpers.change_array("0.name", "name")
