defmodule Dynamo.Ecto.JavaScript do
  @moduledoc """
  An Ecto type to represent DynamoDB's JavaScript functions

  ## Using in queries

      javascript = Dynamo.Ecto.Helpers.javascript("this.visits === count", count: 1)
  ...
  @doc """
  Converts a `Dynamo.Ecto.JavaScript` into `BSON.JavaScript`
  """
  ...
  @doc """
  Converts a `BSON.JavaScript` into `Dynamo.Ecto.JavaScript`
  """
