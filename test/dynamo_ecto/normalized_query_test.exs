defmodule Dynamo.Ecto.NormalizedQueryTest do
  ...
  @id_types %{binary_id: Dynamo.Ecto.ObjectID}

  defp normalize(query, operation \\ :all) do
    {query, params, _key} = Ecto.Query.Planner.prepare(query, operation, Dynamo.Ecto)
    query = Ecto.Query.Planner.normalize(query, operation, Dynamo.Ecto)
